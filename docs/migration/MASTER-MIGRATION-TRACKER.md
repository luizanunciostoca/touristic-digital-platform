...
| MIG-0011 | afiliados | Affiliates | FEATURE-0010 | `packages/affiliates` + `services/affiliates` | 9 | migrating | M154 adiciona schema MySQL, repositories duráveis, mutation transacional, adapters provider-neutral, materialization persistida e API HTTP autenticada; branch ainda não incorporada à main | 15 PASS / 10 PARTIAL / 0 GAP / 2 N/A; testes locais passam, mas MySQL, Ordering/Financial readback real, retenção/DSR, browser/E2E e Actions permanecem pendentes | `AFFILIATES-MIGRATION-MATRIX.md`; `AFFILIATES-M154-EVIDENCE.md`; `AFFILIATES-ROLLOUT-ROLLBACK.md`; branch M154 | crítico |
