...
| Contract                                | Frozen V1 evidence                                                    | V2 evidence at M62                                                                                                                                                                            | Status  | Migration decision                                                                                                                                   |
| --------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
...
`Business domain/browser behavior`, `Business profile behavior` and `Live Business runtime` remain `PARTIAL`. `Checkout client` remains `N/A` for Business because provider/payment execution belongs to `FEATURE-0009`. M62 reaches zero Business-owned GAPs without claiming full Business equivalence.
