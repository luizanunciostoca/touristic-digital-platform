...
const groups = [
  {
    label: "Principal",
    items: [
      { key: "global", label: "Visão Global", view: "overview", icon: "globe", canonical: true },
    ],
  },
  {
    label: "Operação",
  ...
  },
  {
    ...
    items: [
      { key: "businesses", label: "Empresas", view: "businesses", icon: "building", canonical: true },
      { key: "users", label: "Usuários", view: "users", icon: "users", canonical: true },
      { key: "affiliates", label: "Afiliados", view: "affiliates", icon: "network", canonical: true },
    ],
  },
  {
    label: "Comercial",
    items: [
      ...
      { key: "products", label: "Produtos", view: "products", icon: "box", canonical: true },
  ...
  },
  {
    label: "Reservas",
    items: [
      { key: "reservations", label: "Reservas", view: "reservations", icon: "calendar", canonical: true },
      { key: "ticketing", label: "Ticketing", view: "ticketing", icon: "ticket", canonical: true },
  ...
  },
  {
    label: "Financeiro",
    items: [
      { key: "orders", label: "Pedidos", view: "orders", icon: "cart", canonical: true },
      { key: "payments", label: "Pagamentos", view: "financial", icon: "card", canonical: true },
      { key: "refunds", label: "Reembolsos", view: "financial", icon: "return" },
      { key: "commissions", label: "Comissões", view: "financial", icon: "percent" },
    ],
  },
  {
    label: "Controle",
    items: [
      { key: "support", label: "Suporte", view: "support", icon: "headset", canonical: true },
      { key: "audit", label: "Auditoria", view: "audit", icon: "audit", canonical: true },
    ],
  },
  {
    label: "Plataforma",
    items: [
      { key: "system", label: "Sistema", view: "system", icon: "server", canonical: true },
      { key: "integrations", label: "Integrações", view: "settings", icon: "link" },
      { key: "settings", label: "Configurações", view: "settings", icon: "settings", canonical: true },
    ],
  },
];
...
const iconPaths = {
  globe: '<circle cx="12" cy="12" r="8"></circle><path d="M4 12h16M12 4a13 13 0 0 1 0 16M12 4a13 13 0 0 0 0 16"></path>',
  ...
  users: '<circle cx="9" cy="8" r="3"></circle><path d="M3.5 19c.7-3 2.5-5 5.5-5s4.8 2 5.5 5M16 6.5a2.5 2.5 0 0 1 0 5M16 14c2.2.2 3.7 1.7 4.2 4"></path>',
  network: '<circle cx="6" cy="7" r="2"></circle><circle cx="18" cy="7" r="2"></circle><circle cx="12" cy="18" r="2"></circle><path d="m7.7 8.1 3.1 7.6M16.3 8.1l-3.1 7.6M8 7h8"></path>',
  ...
  ticket: '<path d="M4 8a2 2 0 0 0 0 4v5h16v-5a2 2 0 0 0 0-4V5H4z"></path><path d="M12 7v8"></path>',
  ...
  percent: '<path d="m7 17 10-10"></path><circle cx="7" cy="7" r="2"></circle><circle cx="17" cy="17" r="2"></circle>',
  headset: '<path d="M4 13v-2a8 8 0 0 1 16 0v2M4 13h3v6H5a1 1 0 0 1-1-1zM20 13h-3v6h2a1 1 0 0 0 1-1zM17 19c0 1.1-1.8 2-4 2"></path>',
...
function rebuildNav() {
  if (!nav) return;
  if (nav.querySelector(".nav-group") && nav.querySelector("[data-shell-key]")) {
    syncActive();
    return;
  }
