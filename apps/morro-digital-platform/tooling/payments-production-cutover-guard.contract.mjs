...
const productionPublicKeyFixture = `${"APP"}_USR-${"fixture-public-key-1234567890"}`;
const productionSubscriptionPublicKeyFixture = `${"APP"}_USR-${"fixture-subscription-public-key-1234567890"}`;
