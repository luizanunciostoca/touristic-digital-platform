...
describe("UX Design V2 shared component adoption", () => {
  ...
  it(
    "uses shared button primitives in the real Home Navigation and Assistant shell",
    async () => {
  ...
  it(
    "uses the same shared icon-button primitive for runtime-created 3D controls",
    async () => {
