...
const CATEGORY_PLACE_ACTIONS = Object.freeze({
  restaurants: Object.freeze([
    ...
    {
      actionId: "place.photos",
      icon: "📸",
      key: "photos",
      value: "ver fotos",
    },
    {
      actionId: "place.whatsapp",
      icon: "💬",
      key: "whatsapp",
      value: "whatsapp",
    },
  ...
  hotels: Object.freeze([
    {
      actionId: "hotel.accommodations",
      icon: "🛏️",
      key: "accommodations",
      value: "ver acomodações",
    },
    {
      actionId: "hotel.reserve",
      icon: "📅",
      key: "book",
      value: "reservar",
    },
  ...
  tours: Object.freeze([
    ...
    {
      actionId: "tour.schedule",
      icon: "🕐",
      key: "viewHours",
      value: "ver horários",
    },
    {
      actionId: "tour.meeting_point",
      icon: "📍",
      key: "meetingPoint",
      value: "ponto de encontro",
    },
    {
      actionId: "place.photos",
      icon: "📸",
    ...
    {
      actionId: "tour.interactive",
      icon: "ℹ️",
      key: "interactiveTour",
      value: "fazer tour interativo",
    },
    {
      actionId: "place.whatsapp",
      icon: "💬",
  ...
  transport: Object.freeze([
    ...
    },
    {
      ...
      icon: "🚕",
      key: "requestTransportFull",
      value: "solicitar transporte",
    },
    {
      actionId: "transport.ticket",
      icon: "🎫",
      key: "buyTransportTicket",
      value: "comprar passagem",
    },
    {
      actionId: "transport.stop",
      icon: "📍",
      key: "viewStop",
      value: "ver ponto",
    },
    {
      actionId: "transport.schedule",
      icon: "🕐",
      key: "hours",
      value: "horários",
    },
  ...
  shops: Object.freeze([
    ...
    {
      actionId: "shop.products",
      icon: "📸",
      key: "viewProducts",
      value: "ver produtos",
    },
    {
      actionId: "shop.schedule",
      icon: "🕐",
      key: "hours",
      value: "horários",
    },
